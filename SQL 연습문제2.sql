...
insert into bank_customer values ("830513-2000003", "선덕여왕", 1, "010-1324-1003", "서울시 마포구");
...
insert into bank_account values('101-23-1006', 'L2', '예금담보대출', '730423-1000001', 25000, '2013-12-11');
...
join bank_customer as c on c_no = a_c_no
where t_dist =1
