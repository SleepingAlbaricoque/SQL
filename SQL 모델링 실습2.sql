insert into dept values ( 101, '소아과', '김유신', '051-123-0101');
insert into dept values ( 102, '내과', '김춘추', '051-123-0102');
insert into dept values ( 103, '외과', '장보고', '051-123-0103');
insert into dept values ( 104, '피부과', '선덕여왕', '051-123-0104');
insert into dept values ( 105, '이비인후과', '강감찬', '051-123-0105');
insert into dept values ( 106, '산부인과', '신사임당', '051-123-0106');
insert into dept values ( 107, '흉부외과', '류성룡', '051-123-0107');
insert into dept values ( 108, '정형외과', '송상현', '051-123-0108');
insert into dept values ( 109, '신경외과', '이순신', '051-123-0109');
insert into dept values ( 110, '비뇨기과', '정약용', '051-123-0110');
insert into dept values ( 111, '안과', '박지원', '051-123-0111');
insert into dept values ( 112, '치과', '전봉준', '051-123-0112');

insert into doc values ('D101101', '김유신', '1976-01-21', 'M', 101, '과장', '010-1101-1976', 'kimys@bw.com'); 
insert into doc values ('D101102', '계백', '1975-06-11', 'M', 101, '전문의', '010-1102-1975', 'gaeback@bw.com'); 
insert into doc values ('D101103', '김관창', '1989-05-30', 'M', 101, '전문의', '010-1103-1989', 'kwanch@bw.com'); 
insert into doc values ('D102101', '김춘추', '1979-04-13', 'M', 102, '과장', '010-2101-1979', 'kimcc@bw.com'); 
insert into doc values ('D102104', '이사부', '1966-09-12', 'M', 102, '전문의', '010-2104-1966', 'leesabu@bw.com'); 
insert into doc values ('D103101', '장보고', '1979-07-28', 'M', 103, '과장', '010-3101-1979', 'jangbg@bw.com'); 
insert into doc values ('D104101', '선덕여왕', '1984-06-15', 'F', 104, '과장', '010-4101-1984', 'queen@bw.com'); 
insert into doc values ('D105101', '강감찬', '1965-10-21', 'M', 105, '과장', '010-5101-1965', 'kang@bw.com'); 
insert into doc values ('D106101', '신사임당', '1972-11-28', 'F', 106, '과장', '010-6101-1972', 'sinsa@bw.com'); 
insert into doc values ('D107103', '이이', '1992-09-07', 'M', 107, '전문의', '010-7103-1992', 'leelee@bw.com'); 
insert into doc values ('D107104', '이황', '1989-12-09', 'M', 107, '전문의', '010-7104-1989', 'hwang@bw.com'); 
insert into doc values ('D108101', '송상현', '1977-03-14', 'M', 108, '과장', '010-8101-1977', 'ssh@bw.com'); 
update doc set docGen = 'F' where docName = '선덕여왕' or docName = '신사임당';
...
insert into nurse values ('N104101', '김태희', '1979-08-28', 'F', 104, '주임', '010-3101-7908', 'tae@bw.com');
...
insert into patient (patId, docId, nurId, patName, patJumin, patGen, patAddr, patPh, patJob) values ('P102101', 'D102101', 'N102101', '정우성', '760121-1234567', 'M', '서울', '010-1101-7601', '배우');
insert into patient (patId, docId, nurId, patName, patJumin, patGen, patAddr, patPh, patJob) values ('P103101', 'D103101', 'N103101', '이정재', '750611-1234567', 'M', '서울', '010-1102-7506', '배우');
...
insert into patient (patId, docId, nurId, patName, patJumin, patGen, patAddr, patPh, patJob) values ('P102103', 'D102104', 'N102102', '유재석', '721128-1234567', 'M', '부산', '010-6101-7211', '개그맨');
insert into patient (patId, docId, nurId, patName, patJumin, patGen, patAddr, patPh, patJob) values ('P107101', 'D107104', 'N107101', '강호동', '920907-1234567', 'M', '부산', '010-7103-9209', '개그맨');
